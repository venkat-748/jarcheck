...
class datecheck {
	static Logger log=Logger.getLogger(datecheck.class);
	 static String log4jConfPath = "/home/venkat-zstk271/eclipse-workspace/TicketResevation/src/main/java/log4j.properties";
	public static void main(String[] args) throws ParseException {
	  ...
	  public static boolean dateCheck(String date1) throws ParseException {
		  log.info("the datecheck is running ... ");
...
//	        System.out.println("The last date is:"+ datString+"-"+monString+"-"+year);
